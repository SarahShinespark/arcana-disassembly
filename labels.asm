   ...
   Text1_Var00 = $00109B; !^ Stores a $04 (x offset for $28b text vars) ^!
   Text1_Var01 = $00109D
   Text1_Var02 = $00109F
   Text1_Var03 = $0010A1
   Text1_Var04 = $0010A3
   ...
   Game_State = $0011C1; !^ 00=Can move. 02=Fighting. -1=Game over. (values -1 to 5) ^!
   ...
   BG1_HScroll = $00210D; !^ Horizontal scroll ^!
   BG1_VScroll = $00210E; !^ Vertical scroll ^!
   BG2_HScroll = $00210F
   BG2_VScroll = $002110
   BG3_HScroll = $002111
   BG3_VScroll = $002112
   ...
   M7_MATRIX_A = $00211B; !^ Mode 7 Matrix A (also $2134/6) ^!
   M7_MATRIX_B = $00211C; !^ Mode 7 Matrix B (also $2134/6) ^!
   M7_MATRIX_C = $00211D; !^ Mode 7 Matrix C (write twice) ^!
   M7_MATRIX_D = $00211E; !^ Mode 7 Matrix D ^!
   M7_CENTER_X = $00211F; !^ Mode 7 Center X ^!
   M7_CENTER_Y = $002120; !^ Mode 7 Center Y ^!
   ...
   M7_Product_Low = $002134; !^ 2's compliment product of $211b(2b), 8 bit most recently written to $#211c ^!
   M7_Product_mid = $002135
   M7_Product_hi = $002136
   ...
   STAT78 = $00213F
   APU0 = $002140; !^ For communicating with the SPC700 ^!
   APU1 = $002141
   APU2 = $002142
   APU3 = $002143
   ...
   Condition_Enemy2 = $0011CD
   Condition_Enemy3 = $0011CF
   Condition_Enemy4 = $0011D1
   Condition_Enemy5 = $0011D3
   Condition_Enemy6 = $0011D5
   Condition_Enemy7 = $0011D7
   Party_order_slot2 = $0011F5
   Party_order_slot3 = $0011F7
   Party_order_slot4 = $0011F9
   Enemy_order_slot2 = $0011FD
   Enemy_order_slot3 = $0011FF
   Enemy_order_slot4 = $001201
   Enemy_order_slot5 = $001203
   Enemy_order_slot6 = $001205
   Enemy_order_slot7 = $001207
   Enemy_order_slot8 = $001209
   Curr_HP_Guest1 = $0012F7
   Curr_HP_Guest2 = $0012F9
   Curr_HP_Spirit_copy = $00130D
   Curr_HP_Guest1_copy = $00130F
   Curr_HP_Guest2_copy = $001311
   Spell_list_Spirit = $001499
   Spell_list_Guest1 = $0014D9
   Spell_list_Guest2 = $001519
   Text1_Var09 = $0010AD
   Text1_Var08 = $0010AB
   Text1_Var07 = $0010A9
   Text1_Var06 = $0010A7
   Text1_Var05 = $0010A5
   Text_Color = $000424; !^ Set by A140 (0D958C-90, 02, 02) ^!
   Temp_something = $0018C1
   Text1_Var0A = $0010AF
   Text1_Var0B = $0010B1
   Text1_Var0C = $0010B3
   Text1_Var0D = $0010B5
